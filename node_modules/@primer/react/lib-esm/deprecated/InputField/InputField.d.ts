...
declare const InputField: <T extends Record<string, FormValidationStatus>>({ children, disabled, id: idProp, required, validationMap, validationResult, }: Props<T>) => React.JSX.Element;
export type InputFieldComponentProps = ComponentProps<typeof InputField>;
declare const _default: (<T extends Record<string, FormValidationStatus>>({ children, disabled, id: idProp, required, validationMap, validationResult, }: Props<T>) => React.JSX.Element) & {
    Caption: React.FC<{
        children?: React.ReactNode;
    }>;
