...
const ChoiceFieldset = ({
  ...
  const validationChildren = (_React$Children$map = React__default.Children.map(children, child => /*#__PURE__*/React__default.isValidElement(child) && child.type === ChoiceFieldsetValidation ? child : null)) === null || _React$Children$map === void 0 ? void 0 : _React$Children$map.filter(Boolean);
  ...
  return /*#__PURE__*/React__default.createElement(Slots, {
    ...
    const isLegendVisible = /*#__PURE__*/React__default.isValidElement(slots.Legend) && slots.Legend.props.isVisible;
    ...
    }, React__default.Children.toArray(children).filter(child => /*#__PURE__*/React__default.isValidElement(child) && child.type !== ChoiceFieldsetValidation), /*#__PURE__*/React__default.createElement(Box, {
      mb: isLegendVisible ? 3 : undefined
    }, slots.Legend, slots.Description), slots.ChoiceList), validationChildToRender && /*#__PURE__*/React__default.createElement(Box, {
      mt: 3
    }, validationMap && validationResult && validationMessageId && /*#__PURE__*/React__default.createElement(ValidationAnimationContainer, {
      show: true
