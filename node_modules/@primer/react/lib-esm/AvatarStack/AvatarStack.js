...
const AvatarStack = ({
  ...
  const getAvatarChildSizes = () => {
    ...
    return React__default.Children.toArray(children).reduce((acc, child) => {
      // if child is not an Avatar, return the default avatar sizes from the accumulator
      if (! /*#__PURE__*/React__default.isValidElement(child)) return acc;
  ...
  return /*#__PURE__*/React__default.createElement(AvatarStackWrapper, {
    count: count,
