...
const UnderlineNav = /*#__PURE__*/forwardRef(({
  ...
  return /*#__PURE__*/React__default.createElement(UnderlineNavContext.Provider, {
    ...
    ref: listRef,
    role: "list"
  }, listItems, menuItems.length > 0 && /*#__PURE__*/React__default.createElement(MoreMenuListItem, {
    ref: moreMenuRef
    ...
    }, menuItemProps), /*#__PURE__*/React__default.createElement(Box, {
      as: "span",
      sx: {
        display: 'flex',
        alignItems: 'center',
    ...
    }, menuItemChildren, loadingCounters ? /*#__PURE__*/React__default.createElement(LoadingCounter, null) : counter !== undefined && /*#__PURE__*/React__default.createElement(Box, {
      as: "span",
