import React__default, { forwardRef, useState, useRef, useEffect, useImperativeHandle, useCallback, useMemo } from 'react';
...
const MarkdownEditor = /*#__PURE__*/forwardRef(({
  ...
  })), (_slots$footer = slots.footer) !== null && _slots$footer !== void 0 ? _slots$footer : /*#__PURE__*/React__default.createElement(CoreFooter, null, /*#__PURE__*/React__default.isValidElement(slots.actions) && slots.actions.props.children))));
});
