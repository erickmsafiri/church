...
import { FilterRemoveIcon, XIcon, SearchIcon, XCircleFillIcon } from '@primer/octicons-react';
...
const SelectPanelContext = /*#__PURE__*/React__default.createContext({
  title: '',
  onCancel: () => {},
...
const SelectPanel = props => {
  ...
  const contents = React__default.Children.map(props.children, child => {
  ...
  const [internalOpen, setInternalOpen] = React__default.useState(props.defaultOpen);
  // sync open state
  React__default.useEffect(() => setInternalOpen(props.open), [props.open]);
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(AnchoredOverlay
  // @ts-ignore todo
  , {
    anchorRef: anchorRef,
  ...
  }, /*#__PURE__*/React__default.createElement(SelectPanelContext.Provider, {
    value: {
      title: props.title,
  ...
  }, slots.header || /*#__PURE__*/React__default.createElement(SelectPanel.Header, null), /*#__PURE__*/React__default.createElement(Box, {
    as: "div",
...
const SelectPanelButton = /*#__PURE__*/React__default.forwardRef((props, anchorRef) => {
  // @ts-ignore todo
...
const SelectPanelHeader = ({
  ...
  const {
    ...
    onCancel,
    onClearSelection
  } = React__default.useContext(SelectPanelContext);
  ...
  }, props), title), /*#__PURE__*/React__default.createElement(Box, null, onClearSelection ? /*#__PURE__*/React__default.createElement(Tooltip, {
...
const SelectPanelSearchInput = props => {
  const inputRef = /*#__PURE__*/React__default.createRef();
  const {
    setSearchQuery
  } = React__default.useContext(SelectPanelContext);
  ...
  , _extends({
    ...
    placeholder: "Search",
    trailingAction: /*#__PURE__*/React__default.createElement(TextInput.Action, {
...
const SelectPanelFooter = ({
  ...
  }, props.children), hidePrimaryActions ? null : /*#__PURE__*/React__default.createElement(Box, {
    sx: {
      display: 'flex',
      gap: 2
    }
