...
const InlineToggle = ({
  ...
  showAllTokensInline,
  totalLength
}) => isOverflowShown ? /*#__PURE__*/React__default.createElement(Button, {
  ref: collapseButtonRef,
  onClick: collapseInlineExpandedChildren,
  size: "small",
  variant: "invisible"
}, "Show less") : hiddenItemIds.length ? /*#__PURE__*/React__default.createElement(Button, {
  ref: expandButtonRef,
  variant: "invisible",
  size: "small",
  onClick: showAllTokensInline
}, /*#__PURE__*/React__default.createElement(VisuallyHidden, null, "Show all ", totalLength), /*#__PURE__*/React__default.createElement("span", {
  "aria-hidden": "true"
...
const OverlayToggle = ({
  ...
  overlayWidth,
  totalLength
}) => hiddenItemIds.length ? /*#__PURE__*/React__default.createElement(AnchoredOverlay, {
  ...
  renderAnchor: props => /*#__PURE__*/React__default.createElement(Button, _extends({
    variant: "invisible",
    size: "small"
  }, props, {
    ref: expandButtonRef
...
const LabelGroup = ({
  ...
  const collapseButtonRef = React__default.useRef(null);
  const firstHiddenIndexRef = React__default.useRef(undefined);
  const [visibilityMap, setVisibilityMap] = React__default.useState({});
  const [isOverflowShown, setIsOverflowShown] = React__default.useState(false);
  const [buttonClientRect, setButtonClientRect] = React__default.useState({
    width: 0,
    right: 0,
    height: 0,
    x: 0,
  ...
  const expandButtonRef = React__default.useCallback(node => {
    if (node !== null) {
  ...
  const hideChildrenAfterIndex = React__default.useCallback(truncateAfter => {
  ...
  const openOverflowOverlay = React__default.useCallback(() => setIsOverflowShown(true), [setIsOverflowShown]);
  const closeOverflowOverlay = React__default.useCallback(() => {
    setIsOverflowShown(false);
  }, [setIsOverflowShown]);
  const collapseInlineExpandedChildren = React__default.useCallback(() => {
    setIsOverflowShown(false);
  ...
  const showAllTokensInline = React__default.useCallback(() => {
    setVisibilityMap({});
  ...
  return visibleChildCount ? /*#__PURE__*/React__default.createElement(StyledLabelGroupContainer, {
    ref: containerRef,
    "data-overflow": overflowStyle === 'inline' && isOverflowShown ? 'inline' : undefined,
    sx: sxProp
  }, React__default.Children.map(children, (child, index) => /*#__PURE__*/React__default.createElement(ItemWrapper
  ...
  , {
  ...
  }, child)), overflowStyle === 'inline' ? /*#__PURE__*/React__default.createElement(InlineToggle, {
    ...
    totalLength: React__default.Children.toArray(children).length
  }) : /*#__PURE__*/React__default.createElement(OverlayToggle, {
    ...
    totalLength: React__default.Children.toArray(children).length
  }, children)) : /*#__PURE__*/React__default.createElement(StyledLabelGroupContainer, {
