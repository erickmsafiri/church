...
declare const _default: React.ForwardRefExoticComponent<Omit<SelectMenuInternalProps, "ref"> & React.RefAttributes<HTMLDetailsElement>> & {
    ...
    Filter: React.ForwardRefExoticComponent<{
        ...
        leadingVisual?: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.ComponentClass<any, any> | React.FunctionComponent<any> | null | undefined;
        trailingVisual?: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | React.ComponentClass<any, any> | React.FunctionComponent<any> | null | undefined;
        trailingAction?: React.ReactElement<React.HTMLProps<HTMLButtonElement>, string | React.JSXElementConstructor<any>> | undefined;
    } & Pick<import("../../internal/components/TextInputWrapper").StyledWrapperProps, "monospace" | "maxWidth" | "minWidth" | "width" | "block" | "size" | "sx" | "disabled" | "variant" | "validationStatus" | "contrast"> & React.RefAttributes<HTMLInputElement>>;
    ...
    Tab: {
        ({ tabName, index, className, onClick, ...rest }: import("./SelectMenuTab").SelectMenuTabProps): React.JSX.Element;
        displayName: string;
    };
    TabPanel: {
        ({ tabName, className, children, ...rest }: import("./SelectMenuTabPanel").SelectMenuTabPanelProps): React.JSX.Element;
        displayName: string;
    };
    Header: {
        ({ children, theme, ...rest }: {
