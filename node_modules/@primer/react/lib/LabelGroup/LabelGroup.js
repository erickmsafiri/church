...
const InlineToggle = ({
  ...
  showAllTokensInline,
  totalLength
}) => isOverflowShown ? /*#__PURE__*/React__default.default.createElement(index.Button, {
  ref: collapseButtonRef,
  onClick: collapseInlineExpandedChildren,
  size: "small",
  variant: "invisible"
}, "Show less") : hiddenItemIds.length ? /*#__PURE__*/React__default.default.createElement(index.Button, {
  ref: expandButtonRef,
  variant: "invisible",
  size: "small",
...
const OverlayToggle = ({
  ...
  renderAnchor: props => /*#__PURE__*/React__default.default.createElement(index.Button, _extends({
    variant: "invisible",
    size: "small"
  }, props, {
    ref: expandButtonRef
